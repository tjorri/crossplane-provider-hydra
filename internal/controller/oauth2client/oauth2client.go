...
func Setup(mgr ctrl.Manager, o controller.Options) error {
	...
	r := managed.NewReconciler(mgr,
		...
		managed.WithRecorder(event.NewAPIRecorder(mgr.GetEventRecorderFor(name))), //nolint:staticcheck // TODO: migrate to GetEventRecorder when crossplane-runtime supports it
