...
func Setup(mgr ctrl.Manager, o controller.Options) error {
	...
	r := providerconfig.NewReconciler(mgr,
		...
		providerconfig.WithRecorder(event.NewAPIRecorder(mgr.GetEventRecorderFor(name))), //nolint:staticcheck // TODO: migrate to GetEventRecorder when crossplane-runtime supports it
	)
